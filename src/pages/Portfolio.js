        ...
        <Row>
            <div class="col-md-12 midsection">
                ...
                <Row>
                    <Col size="md-4 sm-12">
                        <div className="button-container">
                            <img className="img-fluid portfolio-pic" src={require ("../components/assets/images/pw-generator.png")} alt="Password Generator"/>
                    ...
                    <Col size="md-4 sm-12">
                        <div className="button-container">
                            <img className="img-fluid portfolio-pic" src={require("../components/assets/images/weather-app.PNG")} alt="Weather Dashboard"/>
                    ...
                    <Col size="md-4 sm-12">
                        <div className="button-container">
                            <img className="img-fluid portfolio-pic" src={require("../components/assets/images/movie-app.PNG")} alt="Movies & Groovies"/>
                ...
                <Row>
                    <Col size="md-4 sm-12">
                        <div className="button-container">
                            <img className="img-fluid portfolio-pic" src={require("../components/assets/images/note-taker2.PNG")} alt="Note Taker"/>
                    ...
                    <Col size="md-4 sm-12">
                        <div className="button-container">
                            <img className="img-fluid portfolio-pic" src={require("../components/assets/images/banhMi2.jpg")} alt="Banh Mi Log"/>
                    ...
                    <Col size="md-4 sm-12">
                        <div className="button-container">
                            <img className="img-fluid portfolio-pic" src={require("../components/assets/images/podcast-app.jpeg")} alt="Podcast Collection"/>
